...
fl_v = np.load('/Users/aa245567/Desktop/pythonstuff/mgfl_v.npy')
f_vdist = np.load('/Users/aa245567/Desktop/pythonstuff/mgf_vdist.npy')
...
def goodBins(lst1,lst2):
    ...
    arr1 = lst1[np.where((lst1 > 0.0) & (lst2 > 0.0) & (lst1 != np.inf) & (lst2 != np.inf) & (lst1 != np.nan) & (lst2 != np.nan))]
    arr2 = lst2[np.where((lst1 > 0.0) & (lst2 > 0.0) & (lst1 != np.inf) & (lst2 != np.inf) & (lst1 != np.nan) & (lst2 != np.nan))]
...
fig, (axo72mg) = plt.subplots(1,1,figsize=(15,10))
