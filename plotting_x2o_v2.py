...
he2olow2, he2oupp2, he2omed2,hespeed2 = pR.histWRanges(2,'he2o',dlimit,'Oxygen')
c2olow2,c2oupp2,c2omed2,cspeed2=pR.histWRanges(2,'c2o',dlimit,'Oxygen')
n2olow2,n2oupp2,n2omed2,nspeed2=pR.histWRanges(2,'n2o',dlimit,'Oxygen')
ne2olow2,ne2oupp2,ne2omed2,nespeed2=pR.histWRanges(2,'ne2o',dlimit,'Oxygen')
mg2olow2,mg2oupp2,mg2omed2,mgspeed2=pR.histWRanges(2,'mg2o',dlimit,'Oxygen')
si2olow2,si2oupp2,si2omed2,sispeed2=pR.histWRanges(2,'si2o',dlimit,'Oxygen')
s2olow2,s2oupp2,s2omed2,sspeed2=pR.histWRanges(2,'s2o',dlimit,'Oxygen')
fe2olow2,fe2oupp2,fe2omed2,fespeed2=pR.histWRanges(2,'fe2o',dlimit,'Oxygen')
o76low2, o76upp2, o76med2,o76speed2=pR.histWRanges(2,'o76',dlimit,'Oxygen')

he2olow1, he2oupp1, he2omed1,hespeed1 = pR.histWRanges(1,'he2o',dlimit,'Oxygen')
c2olow1,c2oupp1,c2omed1,cspeed1=pR.histWRanges(1,'c2o',dlimit,'Oxygen')
n2olow1,n2oupp1,n2omed1,nspeed1=pR.histWRanges(1,'n2o',dlimit,'Oxygen')
ne2olow1,ne2oupp1,ne2omed1,nespeed1=pR.histWRanges(1,'ne2o',dlimit,'Oxygen')
mg2olow1,mg2oupp1,mg2omed1,mgspeed1=pR.histWRanges(1,'mg2o',dlimit,'Oxygen')
si2olow1,si2oupp1,si2omed1,sispeed1=pR.histWRanges(1,'si2o',dlimit,'Oxygen')
s2olow1,s2oupp1,s2omed1,sspeed1=pR.histWRanges(1,'s2o',dlimit,'Oxygen')
fe2olow1,fe2oupp1,fe2omed1,fespeed1=pR.histWRanges(1,'fe2o',dlimit,'Oxygen')
o76low1, o76upp1, o76med1,o76speed1=pR.histWRanges(1,'o76',dlimit,'Oxygen')

he2olow3, he2oupp3, he2omed3,hespeed3 = pR.histWRanges(3,'he2o',dlimit,'Oxygen')
c2olow3,c2oupp3,c2omed3,cspeed3=pR.histWRanges(3,'c2o',dlimit,'Oxygen')
n2olow3,n2oupp3,n2omed3,nspeed3=pR.histWRanges(3,'n2o',dlimit,'Oxygen')
ne2olow3,ne2oupp3,ne2omed3,nespeed3=pR.histWRanges(3,'ne2o',dlimit,'Oxygen')
mg2olow3,mg2oupp3,mg2omed3,mgspeed3=pR.histWRanges(3,'mg2o',dlimit,'Oxygen')
si2olow3,si2oupp3,si2omed3,sispeed3=pR.histWRanges(3,'si2o',dlimit,'Oxygen')
s2olow3,s2oupp3,s2omed3,sspeed3=pR.histWRanges(3,'s2o',dlimit,'Oxygen')
fe2olow3,fe2oupp3,fe2omed3,fespeed3=pR.histWRanges(3,'fe2o',dlimit,'Oxygen')
o76low3,o76upp3,o76med3,o76speed3=pR.histWRanges(3,'o76',dlimit,'Oxygen')

he2olow0, he2oupp0, he2omed0,hespeed0 = pR.histWRanges(0,'he2o',dlimit,'Oxygen')
c2olow0,c2oupp0,c2omed0,cspeed0=pR.histWRanges(0,'c2o',dlimit,'Oxygen')
n2olow0,n2oupp0,n2omed0,nspeed0=pR.histWRanges(0,'n2o',dlimit,'Oxygen')
ne2olow0,ne2oupp0,ne2omed0,nespeed0=pR.histWRanges(0,'ne2o',dlimit,'Oxygen')
mg2olow0,mg2oupp0,mg2omed0,mgspeed0=pR.histWRanges(0,'mg2o',dlimit,'Oxygen')
si2olow0,si2oupp0,si2omed0,sispeed0=pR.histWRanges(0,'si2o',dlimit,'Oxygen')
s2olow0,s2oupp0,s2omed0,sspeed0=pR.histWRanges(0,'s2o',dlimit,'Oxygen')
fe2olow0,fe2oupp0,fe2omed0,fespeed0=pR.histWRanges(0,'fe2o',dlimit,'Oxygen')
o76low0,o76upp0,o76med0,o76speed0=pR.histWRanges(0,'o76',dlimit,'Oxygen')
