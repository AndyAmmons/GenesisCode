...
def aswics2python(): 
    ...
    pathswics = '/Users/aa245567/Desktop/pythonstuff/ACE_SWICS/'
    pathswep = '/Users/aa245567/Desktop/SWEPAM_data/'
    ...
    for i in range(1,5):
        year = 2000 + i
        ns2hr = idl2python('/Users/aa245567/Desktop/new_SWICS_data_IDL_save_files/Genesis_N_S_O_ratio'+str(year)+'.save')
        nwvthrm = idl2python('/Users/aa245567/Desktop/new_SWICS_data_IDL_save_files/Genesis_V_Vthermal_'+str(year)+'.save')
